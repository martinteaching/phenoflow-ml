...
with open(sys.argv[1], 'r') as file_in, open('matrix_of_matches.json', 'w') as file_out:
    ...
    for cluster_number_of_partition_k in range(0, k):
        ...
        for partition_number in range(2, k):
            dictionary_matrix_of_matches["partition_k_"+str(k)+"_cluster_"+str(cluster_number_of_partition_k)]["partition_k_"+str(partition_number)] = dict()
            ...
            for cluster_number in range(0,partition_number):
                ...
                value_of_match = <VALUE_OF_MATCH_CALCULATION>
            ...
            dictionary_matrix_of_matches["partition_k_"+str(k)+"_cluster_"+str(cluster_number_of_partition_k)]["partition_k_"+str(partition_number)]["max_value_of_match"] = max_value_of_match
            dictionary_matrix_of_matches["partition_k_"+str(k)+"_cluster_"+str(cluster_number_of_partition_k)]["partition_k_"+str(partition_number)]["cluster_with_max_value_of_match"] = cluster_with_max_value_of_match
